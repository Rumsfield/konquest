...
public enum CommandType {
	...
	TOWN    (Material.IRON_DOOR,        "konquest.command.town",    "",   "<town> open|close|add|kick|knight|lord|rename|upgrade|shield [player]", MessagePath.DESCRIPTION_TOWN.getMessage()),
