...
public enum CommandType {
	...
	KINGDOM (Material.GOLDEN_SWORD,     "konquest.command.kingdom", "",   "[menu|create|add|kick|rename] [<name>] [<template>]",            MessagePath.DESCRIPTION_KINGDOM.getMessage()),
	TOWN    (Material.IRON_DOOR,        "konquest.command.town",    "",   "<town> [menu|add|kick|rename|takeover] [<player>]",              MessagePath.DESCRIPTION_TOWN.getMessage()),
