...
/**
 * Support for packets defined in the Minecraft protocol version 755 (1.17) using ProtocolLib
 * https://wiki.vg/Protocol
 * @author Rumsfield
 *
 */
public class TeamPacketSender_p755 implements TeamPacketSender {
