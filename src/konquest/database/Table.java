    	...
    	if(database.exists(name)) {
    		...
    		for(Column col : columns) {
    			if(database.exists(name,col.getName())) {
    				...
    				ChatUtil.printStatus("SQLite database is missing column '"+col.getName()+"' in table '"+name+"', adding it now.");
    		...
    		ChatUtil.printStatus("SQLite database is missing table '"+name+"', creating it now.");
