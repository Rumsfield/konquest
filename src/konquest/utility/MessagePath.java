...
public enum MessagePath {
	...
	MENU_GUILD_TITLE_RELATIONS                  (1, "menu.guild.title-relations"),
	MENU_GUILD_TITLE_REQUESTS                   (1, "menu.guild.title-requests"),
	MENU_GUILD_TITLE_PROMOTION                  (1, "menu.guild.title-promotion"),
	MENU_GUILD_TITLE_DEMOTION                   (1, "menu.guild.title-demotion"),
	MENU_GUILD_TITLE_TRANSFER                   (1, "menu.guild.title-transfer"),
	MENU_GUILD_TITLE_SPECIALIZE                 (1, "menu.guild.title-specialize"),
