...
public enum MessagePath {
	...
	LABEL_ARMISTICE                             (0, "label.armistice"),
	...
	MENU_GUILD_JOIN                             (0, "menu.guild.join"),
	MENU_GUILD_LEAVE                            (0, "menu.guild.leave"),
	MENU_GUILD_INVITES                          (0, "menu.guild.invites"),
	MENU_GUILD_LIST                             (0, "menu.guild.list"),
	MENU_GUILD_RELATION                         (0, "menu.guild.relation"),
	MENU_GUILD_REQUESTS                         (0, "menu.guild.requests"),
	MENU_GUILD_PROMOTE                          (0, "menu.guild.promote"),
	MENU_GUILD_DEMOTE                           (0, "menu.guild.demote"),
	MENU_GUILD_TRANSFER                         (0, "menu.guild.transfer"),
	MENU_GUILD_SPECIAL                          (0, "menu.guild.special"),
	MENU_GUILD_OPEN                             (0, "menu.guild.open"),
	MENU_GUILD_DISBAND                          (0, "menu.guild.disband"),
	MENU_GUILD_DESCRIPTION_JOIN                 (0, "menu.guild.description-join"),
	MENU_GUILD_DESCRIPTION_LEAVE                (0, "menu.guild.description-leave"),
	MENU_GUILD_DESCRIPTION_INVITES              (0, "menu.guild.description-invites"),
	MENU_GUILD_DESCRIPTION_LIST                 (0, "menu.guild.description-list"),
	MENU_GUILD_DESCRIPTION_RELATION             (0, "menu.guild.description-relation"),
	MENU_GUILD_DESCRIPTION_REQUESTS             (0, "menu.guild.description-requests"),
	MENU_GUILD_DESCRIPTION_PROMOTE              (0, "menu.guild.description-promote"),
	MENU_GUILD_DESCRIPTION_DEMOTE               (0, "menu.guild.description-demote"),
	MENU_GUILD_DESCRIPTION_TRANSFER             (0, "menu.guild.description-transfer"),
	MENU_GUILD_DESCRIPTION_SPECIALIZE           (0, "menu.guild.description-specialize"),
	MENU_GUILD_DESCRIPTION_DISBAND              (0, "menu.guild.description-disband"),
	MENU_GUILD_HINT_LEAVE                       (0, "menu.guild.hint-leave"),
	MENU_GUILD_HINT_EXIT                        (0, "menu.guild.hint-exit"),
	MENU_GUILD_HINT_DISBAND                     (0, "menu.guild.hint-disband"),
	MENU_GUILD_HINT_SPECIAL                     (0, "menu.guild.hint-special"),
	MENU_GUILD_HINT_JOIN                        (0, "menu.guild.hint-join"),
	MENU_GUILD_HINT_INVITE_1                    (0, "menu.guild.hint-invite-1"),
	MENU_GUILD_HINT_INVITE_2                    (0, "menu.guild.hint-invite-2"),
	MENU_GUILD_HINT_RELATION                    (0, "menu.guild.hint-relation"),
	MENU_GUILD_HINT_REQUEST_1                   (0, "menu.guild.hint-request-1"),
	MENU_GUILD_HINT_REQUEST_2                   (0, "menu.guild.hint-request-2"),
	MENU_GUILD_HINT_PROMOTE                     (0, "menu.guild.hint-promote"),
	MENU_GUILD_HINT_DEMOTE                      (0, "menu.guild.hint-demote"),
	MENU_GUILD_HINT_TRANSFER                    (0, "menu.guild.hint-transfer"),
	...
	MENU_GUILD_TITLE_LIST                       (0, "menu.guild.title-list"),
	MENU_GUILD_TITLE_RELATIONS                  (0, "menu.guild.title-relations"),
	MENU_GUILD_TITLE_REQUESTS                   (0, "menu.guild.title-requests"),
	MENU_GUILD_TITLE_PROMOTION                  (0, "menu.guild.title-promotion"),
	MENU_GUILD_TITLE_DEMOTION                   (0, "menu.guild.title-demotion"),
	MENU_GUILD_TITLE_TRANSFER                   (0, "menu.guild.title-transfer"),
	MENU_GUILD_TITLE_SPECIALIZE                 (0, "menu.guild.title-specialize"),
	MENU_GUILD_TITLE_DISBAND                    (1, "menu.guild.title-disband"),
	...
	COMMAND_ADMIN_FORCEEXILE_ERROR_MASTER       (0, "command.admin.forceexile.error.master"),
	...
	COMMAND_ADMIN_MONUMENT_ERROR_FAIL_REGION    (0, "command.admin.monument.error.fail-region"),
	...
	COMMAND_EXILE_ERROR_COOLDOWN                (1, "command.exile.error.cooldown"),
	COMMAND_EXILE_ERROR_MASTER                  (0, "command.exile.error.master"),
	COMMAND_FAVOR_NOTICE_MESSAGE                (1, "command.favor.notice.message"),	  
	COMMAND_GUILD_BROADCAST_SANCTION_REMOVE_1   (1, "command.guild.broadcast.sanction-remove-1"),
	COMMAND_GUILD_BROADCAST_SANCTION_REMOVE_2   (1, "command.guild.broadcast.sanction-remove-2"),
	COMMAND_GUILD_BROADCAST_SANCTION_ADD_1      (1, "command.guild.broadcast.sanction-add-1"),
	COMMAND_GUILD_BROADCAST_SANCTION_ADD_2      (1, "command.guild.broadcast.sanction-add-2"),
	COMMAND_GUILD_BROADCAST_ARMISTICE_REMOVE_1  (1, "command.guild.broadcast.armistice-remove-1"),
	COMMAND_GUILD_BROADCAST_ARMISTICE_REMOVE_2  (1, "command.guild.broadcast.armistice-remove-2"),
	COMMAND_GUILD_BROADCAST_ARMISTICE_ACCEPT_1  (1, "command.guild.broadcast.armistice-accept-1"),
	COMMAND_GUILD_BROADCAST_ARMISTICE_ACCEPT_2  (1, "command.guild.broadcast.armistice-accept-2"),
	COMMAND_GUILD_BROADCAST_ARMISTICE_OFFER_1   (1, "command.guild.broadcast.armistice-offer-1"),
	COMMAND_GUILD_BROADCAST_ARMISTICE_OFFER_2   (1, "command.guild.broadcast.armistice-offer-2"),
	COMMAND_GUILD_BROADCAST_TRANSFER            (2, "command.guild.broadcast.transfer"),
	COMMAND_GUILD_BROADCAST_PROMOTE             (2, "command.guild.broadcast.promote"),
	COMMAND_GUILD_BROADCAST_DEMOTE              (2, "command.guild.broadcast.demote"),
	COMMAND_GUILD_NOTICE_CREATE                 (1, "command.guild.notice.create"),
	COMMAND_GUILD_NOTICE_INVITE                 (1, "command.guild.notice.invite"),
	COMMAND_GUILD_NOTICE_KICK                   (1, "command.guild.notice.kick"),
	COMMAND_GUILD_NOTICE_RENAME                 (1, "command.guild.notice.rename"),
	COMMAND_GUILD_NOTICE_SPECIALIZE             (2, "command.guild.notice.specialize"),
	COMMAND_GUILD_NOTICE_PAY                    (0, "command.guild.notice.pay"),
	COMMAND_GUILD_NOTICE_DISCOUNT               (2, "command.guild.notice.discount"),
	COMMAND_GUILD_NOTICE_OPEN                   (1, "command.guild.notice.open"),
	COMMAND_GUILD_NOTICE_CLOSED                 (1, "command.guild.notice.closed"),
	COMMAND_GUILD_NOTICE_JOINED                 (1, "command.guild.notice.joined"),
	COMMAND_GUILD_NOTICE_REQUEST_JOIN           (1, "command.guild.notice.request-join"),
	COMMAND_GUILD_NOTICE_REQUEST_NEW            (0, "command.guild.notice.request-new"),
	COMMAND_GUILD_NOTICE_INVITE_NEW             (0, "command.guild.notice.invite-new"),
	COMMAND_GUILD_NOTICE_INVITE_DECLINE         (1, "command.guild.notice.invite-decline"),
	COMMAND_GUILD_NOTICE_LEAVE                  (1, "command.guild.notice.leave"),
	COMMAND_GUILD_ERROR_OTHER_GUILD             (0, "command.guild.error.other-guild"),
	COMMAND_GUILD_ERROR_NO_GUILD                (0, "command.guild.error.no-guild"),
	COMMAND_GUILD_ERROR_PLAYER_GUILD            (1, "command.guild.error.player-guild"),
	COMMAND_GUILD_ERROR_SANCTION                (1, "command.guild.error.sanction"),
	COMMAND_GUILD_ERROR_LEAVE_FIRST             (0, "command.guild.error.leave-first"),
	...
	COMMAND_JOIN_ERROR_KINGDOM_COOLDOWN         (1, "command.join.error.kingdom-cooldown"),
