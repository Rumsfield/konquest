...
public enum AdminCommandType {
	...
	KINGDOM     (Material.GOLDEN_SWORD,			"konquest.command.admin.kingdom",      "menu|create|destroy|add|kick|rename|admin <kingdom> [<name>]", MessagePath.DESCRIPTION_ADMIN_KINGDOM.getMessage()),
