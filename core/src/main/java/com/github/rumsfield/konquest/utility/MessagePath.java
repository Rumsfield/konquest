...
public enum MessagePath {
	...
	LABEL_KINGDOM_RANK                          (0, "label.kingdom-rank"),
	LABEL_KINGDOM_RESIDENTS                     (0, "label.kingdom-residents"),
	...
	LABEL_MOBS                                  (0, "label.mobs"),
	LABEL_MODIFIED                              (0, "label.modified"),
	LABEL_MODIFIER                              (0, "label.modifier"),
	...
	LABEL_RETURN                                (0, "label.return"),
	LABEL_RUINS                                 (0, "label.ruins"),
	LABEL_SANCTUARIES                           (0, "label.sanctuaries"),
	...
	RELATIONSHIP_FRIENDLY                       (0, "relationship.friendly"),
	RELATIONSHIP_ENEMY                          (0, "relationship.enemy"),
	RELATIONSHIP_BARBARIAN                      (0, "relationship.barbarian"),
	RELATIONSHIP_ALLY                           (0, "relationship.ally"),
	RELATIONSHIP_TRADER                         (0, "relationship.trader"),
	RELATIONSHIP_PEACEFUL                       (0, "relationship.peaceful"),
	RELATIONSHIP_RANK_MASTER                    (0, "relationship.rank-master"),
	RELATIONSHIP_RANK_OFFICER                   (0, "relationship.rank-officer"),
	RELATIONSHIP_RANK_MEMBER                    (0, "relationship.rank-member"),
	RELATIONSHIP_ROLE_LORD                      (0, "relationship.role-lord"),
	RELATIONSHIP_ROLE_KNIGHT                    (0, "relationship.role-knight"),
	RELATIONSHIP_ROLE_RESIDENT                  (0, "relationship.role-resident"),
    ...
    MAP_LAND                                    (0, "map.land"),
    MAP_OWNER                             		(0, "map.owner"),
	MAP_LORD                             		(0, "map.lord"),
	MAP_KNIGHTS                            		(0, "map.knights"),
	MAP_RESIDENTS                          		(0, "map.residents"),
	MAP_MASTER                             		(0, "map.master"),
	MAP_OFFICERS                           		(0, "map.officers"),
	MAP_MEMBERS                           		(0, "map.members"),
	MAP_RUIN                                    (0, "map.ruin"),
	...
	MENU_HINT_VIEW                              (0, "menu.hint.view"),
	MENU_HINT_OPEN                              (0, "menu.hint.open"),
	MENU_HINT_CHARGE                            (0, "menu.hint.charge"),
	MENU_HINT_CHANGE                            (0, "menu.hint.change"),
	MENU_HINT_TRAVEL                            (0, "menu.hint.travel"),
	MENU_HINT_ACCEPT                            (0, "menu.hint.accept"),
	MENU_HINT_DECLINE                           (0, "menu.hint.decline"),
	MENU_HINT_INCREASE                          (0, "menu.hint.increase"),
	MENU_HINT_DECREASE                          (0, "menu.hint.decrease"),
	MENU_HINT_EXIT                              (0, "menu.hint.exit"),
	MENU_MAIN_TITLE                             (0, "menu.main.title"),
	MENU_MAIN_TITLE_DASHBOARD                   (0, "menu.main.title-dashboard"),
	MENU_MAIN_DASHBOARD                         (0, "menu.main.dashboard"),
	MENU_MAIN_HELP                              (0, "menu.main.help"),
	MENU_MAIN_INFO                              (0, "menu.main.info"),
	MENU_MAIN_QUEST                             (0, "menu.main.quest"),
	MENU_MAIN_STATS                             (0, "menu.main.stats"),
	MENU_MAIN_PREFIX                            (0, "menu.main.prefix"),
	MENU_MAIN_SCORE                             (0, "menu.main.score"),
	MENU_MAIN_KINGDOM                           (0, "menu.main.kingdom"),
	MENU_MAIN_TOWN                              (0, "menu.main.town"),
	MENU_MAIN_TRAVEL                            (0, "menu.main.travel"),
	MENU_MAIN_EVENT                             (0, "menu.main.event"),
	...
	MENU_MAIN_BORDER                            (0, "menu.main.border"),
	MENU_MAIN_FLYING                            (0, "menu.main.flying"),
	MENU_MAIN_HINT_MAP_1                        (0, "menu.main.hint-map-1"),
	MENU_MAIN_HINT_MAP_2                        (0, "menu.main.hint-map-2"),
	MENU_MAIN_HINT_FAVOR                        (0, "menu.main.hint-favor"),
	MENU_MAIN_HINT_SPY                          (0, "menu.main.hint-spy"),
	MENU_MAIN_DESCRIPTION_DASHBOARD             (0, "menu.main.description-dashboard"),
	MENU_MAIN_DESCRIPTION_HELP                  (0, "menu.main.description-help"),
	MENU_MAIN_DESCRIPTION_INFO                  (0, "menu.main.description-info"),
	MENU_MAIN_DESCRIPTION_QUEST                 (0, "menu.main.description-quest"),
	MENU_MAIN_DESCRIPTION_STATS                 (0, "menu.main.description-stats"),
	MENU_MAIN_DESCRIPTION_PREFIX                (0, "menu.main.description-prefix"),
	MENU_MAIN_DESCRIPTION_SCORE                 (0, "menu.main.description-score"),
	MENU_MAIN_DESCRIPTION_KINGDOM               (0, "menu.main.description-kingdom"),
	...
	MENU_EVENT_TODAY                            (0, "menu.event.today"),
	MENU_EVENT_CALENDAR                         (0, "menu.event.calendar"),
	MENU_EVENT_EVENTS                           (0, "menu.event.events"),
	MENU_EVENT_EFFECTS                          (0, "menu.event.effects"),
	...
	MENU_HELP_TITLE_START                       (0, "menu.help.title-start"),
	MENU_HELP_TITLE_COMMANDS                    (0, "menu.help.title-commands"),
	MENU_HELP_TITLE_ADMIN                       (0, "menu.help.title-admin"),
	MENU_HELP_DESCRIPTION_START                 (0, "menu.help.description-start"),
	MENU_HELP_DESCRIPTION_COMMUNITY             (0, "menu.help.description-community"),
	MENU_HELP_DESCRIPTION_MAIN                  (0, "menu.help.description-main"),
	MENU_HELP_DESCRIPTION_COMMANDS              (0, "menu.help.description-commands"),
	MENU_HELP_DESCRIPTION_ADMIN                 (0, "menu.help.description-admin"),
	MENU_HELP_DESCRIPTION_QUEST                 (0, "menu.help.description-quest"),
	MENU_HELP_START                             (0, "menu.help.start"),
	MENU_HELP_COMMUNITY                         (0, "menu.help.community"),
	MENU_HELP_MAIN                              (0, "menu.help.main"),
	MENU_HELP_COMMANDS                          (0, "menu.help.commands"),
	...
	MENU_PREFIX_TITLE_PREFIX                    (0, "menu.prefix.title-prefix"),
	MENU_PREFIX_TITLE_CUSTOM                    (0, "menu.prefix.title-custom"),
	MENU_PREFIX_TITLE_STATS                     (0, "menu.prefix.title-stats"),
	MENU_PREFIX_CURRENT_PREFIX                  (0, "menu.prefix.current-prefix"),
	MENU_PREFIX_DISABLE_PREFIX                  (0, "menu.prefix.disable-prefix"),
	MENU_PREFIX_DESCRIPTION_PREFIX              (0, "menu.prefix.description-prefix"),
	MENU_PREFIX_DESCRIPTION_CUSTOM              (0, "menu.prefix.description-custom"),
	MENU_PREFIX_DESCRIPTION_STATS               (0, "menu.prefix.description-stats"),
	...
	MENU_OPTIONS_KINGDOM_RESIDENTS              (0, "menu.options.kingdom-residents"),
	...
	MENU_OPTIONS_PEACEFUL                       (0, "menu.options.peaceful"),
	MENU_OPTIONS_TRAVEL                         (0, "menu.options.travel"),
	MENU_OPTIONS_BUILD                          (0, "menu.options.build"),
	MENU_OPTIONS_CHEST                          (0, "menu.options.chest"),
	MENU_OPTIONS_MOBS                           (0, "menu.options.mobs"),
	MENU_INFO_CAMP_PLACED                       (0, "menu.info.camp-placed"),
	MENU_INFO_CAMP_MISSING                      (0, "menu.info.camp-missing"),
	MENU_INFO_RUIN_STATUS                       (0, "menu.info.ruin-status"),
	MENU_INFO_RUIN_CAPTURE                      (0, "menu.info.ruin-capture"),
	MENU_INFO_TEMPLATE_KINGDOMS                 (0, "menu.info.template-kingdoms"),
	MENU_TRAVEL_DESCRIPTION_CAPITAL             (0, "menu.travel.description-capital"),
	MENU_TRAVEL_DESCRIPTION_HOME                (0, "menu.travel.description-home"),
	MENU_TRAVEL_DESCRIPTION_CAMP                (0, "menu.travel.description-camp"),
	MENU_TRAVEL_DESCRIPTION_WILD                (0, "menu.travel.description-wild"),
	...
	MENU_KINGDOM_PURCHASE                       (0, "menu.kingdom.purchase"),
	MENU_KINGDOM_OFFERS                         (0, "menu.kingdom.offers"),
	...
	MENU_KINGDOM_DESCRIPTION_PURCHASE           (0, "menu.kingdom.description-purchase"),
	MENU_KINGDOM_DESCRIPTION_OFFERS             (0, "menu.kingdom.description-offers"),
	MENU_KINGDOM_DESCRIPTION_OFFER_ACCEPT       (5, "menu.kingdom.description-offer-accept"),
	...
	MENU_KINGDOM_HINT_PURCHASE                  (0, "menu.kingdom.hint-purchase"),
	...
	MENU_KINGDOM_PURCHASE_OFFERS     			(0, "menu.kingdom.purchase-offers"),
	MENU_KINGDOM_PURCHASE_YOUR_OFFER     		(0, "menu.kingdom.purchase-your-offer"),
	MENU_KINGDOM_PURCHASE_THEIR_OFFER  			(0, "menu.kingdom.purchase-their-offer"),
	...
	MENU_KINGDOM_TITLE_PURCHASE        			(0, "menu.kingdom.title-purchase"),
	MENU_KINGDOM_TITLE_AMOUNT        			(0, "menu.kingdom.title-amount"),
	MENU_KINGDOM_TITLE_OFFERS        			(0, "menu.kingdom.title-offers"),
	...
	PROTECTION_NOTICE_CAMP                      (0, "protection.notice.camp"),
	...
	PROTECTION_NOTICE_PURCHASE                  (2, "protection.notice.purchase"),
	...
	COMMAND_ADMIN_EVENT_NOTICE_CREATE           (1, "command.admin.event.notice.create"),
	COMMAND_ADMIN_EVENT_NOTICE_REMOVE           (1, "command.admin.event.notice.remove"),
	COMMAND_ADMIN_EVENT_NOTICE_START_NOW        (1, "command.admin.event.notice.start-now"),
	COMMAND_ADMIN_EVENT_NOTICE_START_DATE       (2, "command.admin.event.notice.start-date"),
	COMMAND_ADMIN_EVENT_NOTICE_DURATION         (2, "command.admin.event.notice.duration"),
	COMMAND_ADMIN_EVENT_NOTICE_REPETITION       (2, "command.admin.event.notice.repetition"),
	COMMAND_ADMIN_EVENT_NOTICE_EFFECT_ADD       (2, "command.admin.event.notice.effect-add"),
	COMMAND_ADMIN_EVENT_NOTICE_EFFECT_REMOVE    (2, "command.admin.event.notice.effect-remove"),
	COMMAND_ADMIN_EVENT_NOTICE_ENABLE           (1, "command.admin.event.notice.enable"),
	COMMAND_ADMIN_EVENT_NOTICE_DISABLE          (1, "command.admin.event.notice.disable"),
	COMMAND_ADMIN_EVENT_ERROR_YEAR              (0, "command.admin.event.error.year"),
	COMMAND_ADMIN_EVENT_ERROR_MONTH             (0, "command.admin.event.error.month"),
	COMMAND_ADMIN_EVENT_ERROR_DAY               (0, "command.admin.event.error.day"),
	COMMAND_ADMIN_EVENT_ERROR_HOUR              (0, "command.admin.event.error.hour"),
	COMMAND_ADMIN_EVENT_ERROR_MINUTE            (0, "command.admin.event.error.minute"),
	COMMAND_ADMIN_EVENT_ERROR_DURATION          (0, "command.admin.event.error.duration"),
	COMMAND_ADMIN_EVENT_ERROR_REPETITION        (0, "command.admin.event.error.repetition"),
	COMMAND_ADMIN_EVENT_ERROR_EFFECT_CONFLICT   (1, "command.admin.event.error.effect-conflict"),
	COMMAND_ADMIN_EVENT_ERROR_EFFECT_MISSING    (0, "command.admin.event.error.effect-missing"),
	...
	COMMAND_EVENT_BROADCAST_START               (1, "command.event.broadcast.start"),
	COMMAND_EVENT_BROADCAST_END                 (1, "command.event.broadcast.end"),
	COMMAND_EVENT_BROADCAST_ENABLE              (1, "command.event.broadcast.enable"),
	COMMAND_EVENT_BROADCAST_DISABLE             (1, "command.event.broadcast.disable"),
	COMMAND_EVENT_NOTICE_EFFECTS                (0, "command.event.notice.effects"),
	COMMAND_EVENT_NOTICE_NO_EVENTS              (0, "command.event.notice.no-events"),
	COMMAND_EVENT_NOTICE_ENDS                   (1, "command.event.notice.ends"),
	COMMAND_EVENT_NOTICE_STARTS                 (1, "command.event.notice.starts"),
	COMMAND_EVENT_NOTICE_EVENTS                 (1, "command.event.notice.events"),
	COMMAND_EVENT_NOTICE_PAGE                   (0, "command.event.notice.page"),
	COMMAND_EVENT_NOTICE_INFO                   (0, "command.event.notice.info"),
	COMMAND_EVENT_NOTICE_INFO_NO_ACTIVE         (0, "command.event.notice.info-no-active"),
	COMMAND_EVENT_NOTICE_INFO_NO_UPCOMING       (0, "command.event.notice.info-no-upcoming"),
	COMMAND_EVENT_NOTICE_INFO_EFFECTS           (0, "command.event.notice.info-effects"),
	...
	COMMAND_EVENT_PROPERTY_START_INITIAL        (0, "command.event.property.start-initial"),
	COMMAND_EVENT_PROPERTY_START_NEXT           (0, "command.event.property.start-next"),
	COMMAND_EVENT_PROPERTY_END_NEXT             (0, "command.event.property.end-next"),
	COMMAND_EVENT_PROPERTY_EFFECTS              (0, "command.event.property.effects"),
	...
	COMMAND_FAVOR_NOTICE_COST_CAPITAL_SWAP      (0, "command.favor.notice.cost-capital-swap"),
	...
	COMMAND_KINGDOM_BROADCAST_CAPITAL_SWAP      (2, "command.kingdom.broadcast.capital-swap"),
	COMMAND_KINGDOM_BROADCAST_CAPITAL_WARMUP    (3, "command.kingdom.broadcast.capital-warmup"),
	COMMAND_KINGDOM_BROADCAST_CAPITAL_CANCEL    (2, "command.kingdom.broadcast.capital-cancel"),
	...
	COMMAND_KINGDOM_NOTICE_OFFER_PENDING        (0, "command.kingdom.notice.offer-pending"),
	COMMAND_KINGDOM_NOTICE_OFFER_TOWNS          (0, "command.kingdom.notice.offer-towns"),
	COMMAND_KINGDOM_NOTICE_OFFER_PLAYERS        (1, "command.kingdom.notice.offer-players"),
	COMMAND_KINGDOM_NOTICE_OFFER_DECLINED       (2, "command.kingdom.notice.offer-declined"),
	...
	COMMAND_KINGDOM_ERROR_CAPITAL_SWAP_ATTACK   (0, "command.kingdom.error.capital-swap-attack"),
	COMMAND_KINGDOM_ERROR_CAPITAL_SWAP_WAR      (0, "command.kingdom.error.capital-swap-war"),
	...
	DESCRIPTION_CAMP                            (0, "description.camp"),
	...
	PROPERTIES_SPECIALIZE						(0, "properties.specialize"),
	...
	PROPERTIES_SPECIALIZE_NAME					(0, "properties.specialize-name"),
	...
	EFFECTS_PVP									(0, "effects.pvp"),
	EFFECTS_WAR									(0, "effects.war"),
	EFFECTS_PEACE								(0, "effects.peace"),
	EFFECTS_NO_SHIELDS							(0, "effects.no-shields"),
	EFFECTS_NO_ARMOR							(0, "effects.no-armor"),
	EFFECTS_NO_PROTECTION						(0, "effects.no-protection"),
	EFFECTS_NO_IMMUNITY							(0, "effects.no-immunity"),
	EFFECTS_TRAVEL								(0, "effects.travel"),
	EFFECTS_SHIELDS								(0, "effects.shields"),
	EFFECTS_FAVOR_1								(0, "effects.favor-1"),
	EFFECTS_FAVOR_2								(0, "effects.favor-2"),
	EFFECTS_FAVOR_3								(0, "effects.favor-3"),
	EFFECTS_EXP_1								(0, "effects.exp-1"),
	EFFECTS_EXP_2								(0, "effects.exp-2"),
	EFFECTS_EXP_3								(0, "effects.exp-3"),
	EFFECTS_MONUMENT_1							(0, "effects.monument-1"),
	EFFECTS_MONUMENT_2							(0, "effects.monument-2"),
	EFFECTS_MONUMENT_3							(0, "effects.monument-3"),
	EFFECTS_RUIN_1								(0, "effects.ruin-1"),
	EFFECTS_RUIN_2								(0, "effects.ruin-2"),
	EFFECTS_RUIN_3								(0, "effects.ruin-3"),
	EFFECTS_PVP_NAME							(0, "effects.pvp-name"),
	EFFECTS_WAR_NAME							(0, "effects.war-name"),
	EFFECTS_PEACE_NAME							(0, "effects.peace-name"),
	EFFECTS_NO_SHIELDS_NAME						(0, "effects.no-shields-name"),
	EFFECTS_NO_ARMOR_NAME						(0, "effects.no-armor-name"),
	EFFECTS_NO_PROTECTION_NAME					(0, "effects.no-protection-name"),
	EFFECTS_NO_IMMUNITY_NAME					(0, "effects.no-immunity-name"),
	EFFECTS_TRAVEL_NAME							(0, "effects.travel-name"),
	EFFECTS_SHIELDS_NAME						(0, "effects.shields-name"),
	EFFECTS_FAVOR_1_NAME						(0, "effects.favor-1-name"),
	EFFECTS_FAVOR_2_NAME						(0, "effects.favor-2-name"),
	EFFECTS_FAVOR_3_NAME						(0, "effects.favor-3-name"),
	EFFECTS_EXP_1_NAME							(0, "effects.exp-1-name"),
	EFFECTS_EXP_2_NAME							(0, "effects.exp-2-name"),
	EFFECTS_EXP_3_NAME							(0, "effects.exp-3-name"),
	EFFECTS_MONUMENT_1_NAME						(0, "effects.monument-1-name"),
	EFFECTS_MONUMENT_2_NAME						(0, "effects.monument-2-name"),
	EFFECTS_MONUMENT_3_NAME						(0, "effects.monument-3-name"),
	EFFECTS_RUIN_1_NAME							(0, "effects.ruin-1-name"),
	EFFECTS_RUIN_2_NAME							(0, "effects.ruin-2-name"),
	EFFECTS_RUIN_3_NAME							(0, "effects.ruin-3-name"),
