...
public enum MessagePath {
	...
	COMMAND_EVENT_PROPERTY_ENABLED              (0, "command.event.property.enabled"),
	COMMAND_EVENT_PROPERTY_ACTIVE               (0, "command.event.property.active"),
	...
	EFFECTS_FAVOR_4								(0, "effects.favor-4"),
	...
	EFFECTS_FAVOR_4_NAME						(0, "effects.favor-4-name"),
