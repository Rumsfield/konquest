...
public enum MessagePath {
	...
	COMMAND_ADMIN_KINGDOM_ERROR_ADMIN_SET       (1, "command.admin.kingdom.error.admin-set"),
	COMMAND_ADMIN_KINGDOM_ERROR_ADMIN_CLEAR     (1, "command.admin.kingdom.error.admin-clear"),
	...
	SHOP_ERROR_USE_DISABLED                     (0, "quickshop.error.use-disabled"),
	SHOP_ERROR_USE_RELATION                     (0, "quickshop.error.use-relation"),
	SHOP_ERROR_CREATE_TOWN                      (0, "quickshop.error.create-town"),
	SHOP_ERROR_CREATE_CAMP                      (0, "quickshop.error.create-camp"),
	SHOP_ERROR_CREATE_MONUMENT                  (0, "quickshop.error.create-monument"),
	SHOP_ERROR_CREATE_FAIL                      (0, "quickshop.error.create-fail"),
	SHOP_ERROR_CREATE_WILD                      (0, "quickshop.error.create-wild"),
