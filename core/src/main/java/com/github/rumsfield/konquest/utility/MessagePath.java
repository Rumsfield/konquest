...
public enum MessagePath {
	...
	MENU_TOWN_HINT_REQUESTS            			(0, "menu.town.hint-requests"),
	...
	MENU_KINGDOM_DIPLOMACY                      (0, "menu.kingdom.diplomacy"),
	...
	MENU_KINGDOM_DESCRIPTION_DIPLOMACY          (0, "menu.kingdom.description-diplomacy"),
...
//	MENU_GUILD_TITLE_DISBAND                    (1, "menu.guild.title-disband"),
	...
	COMMAND_ADMIN_FLAG_NOTICE_FLAG    			(0, "command.admin.flag.notice.flag"),
	COMMAND_ADMIN_FLAG_NOTICE_VALUE    			(0, "command.admin.flag.notice.value"),
	COMMAND_ADMIN_FLAG_NOTICE_DESCRIPTION    	(0, "command.admin.flag.notice.description"),
...
//	COMMAND_JOIN_ERROR_TOWN_REQUEST             (1, "command.join.error.town-request"),
	...
	COMMAND_KINGDOM_BROADCAST_CONQUER           (2, "command.kingdom.broadcast.conquer"),
	...
	COMMAND_KINGDOM_NOTICE_TEMPLATE             (0, "command.kingdom.notice.template"),
	COMMAND_KINGDOM_NOTICE_PAY                  (0, "command.kingdom.notice.pay"),

	COMMAND_KINGDOM_ERROR_NO_TEMPLATES          (0, "command.kingdom.error.no-templates"),
	COMMAND_KINGDOM_ERROR_BARBARIAN_CREATE      (0, "command.kingdom.error.barbarian-create"),
	COMMAND_KINGDOM_ERROR_INVALID_TEMPLATE      (0, "command.kingdom.error.invalid-template"),
...
//	COMMAND_LEAVE_ERROR_NO_RESIDENT             (1, "command.leave.error.no-resident"),
	...
	PROPERTIES_NEUTRAL							(0, "properties.neutral"),
