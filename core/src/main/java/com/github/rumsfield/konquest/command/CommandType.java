...
public enum CommandType {
	...
	KINGDOM (Material.GOLDEN_SWORD,     "konquest.command.kingdom", "k",  "[menu|create|add|kick|rename|templates] [<name>] [<template>]",  MessagePath.DESCRIPTION_KINGDOM.getMessage()),
	TOWN    (Material.OBSIDIAN,         "konquest.command.town",    "t",  "[<town>] [menu|add|kick|lord|rename] [<name>]",                  MessagePath.DESCRIPTION_TOWN.getMessage()),
